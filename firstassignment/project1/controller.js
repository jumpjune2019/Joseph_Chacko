var Controller = (function() {
	...
	var addEventListener = function(textTrigger, event) {
		var model = this;
	...
	var constructor = function() {
		...
		this.init = function(el, m, v) {
			...
			var addEnter = view.triggerField().getTextInstance(el);
			
			
			
			addButton.addEventListener("click", addButtonClickEvent.bind(model, textTrigger));
			addEnter.addEventListener("keypress", addEventListener.bind(model, textTrigger));
